...
namespace WeatherUnlocked.Core.Interfaces
{
    public interface IWeatherUnlockedService
    {
        /// <summary>
        ...
        Task<CurrentWeatherData> CurrentAsync(float latitude, float longitude);
        ...
        /// <returns>Weather data for given coordinates</returns>
        Task<CurrentWeatherData> CurrentAsync(float latitude, float longitude, Localization localization);
        ...
        Task<CurrentWeatherData> CurrentAsync(string code);
        ...
        /// <param name="localization">Localization for weather descriptions</param>
        /// <returns>Weather data for given post code/zipcode</returns>
        Task<CurrentWeatherData> CurrentAsync(string code, Localization localization);
        ...
        /// <param name="longitude">Longitude coordinate, for example: 74.00</param>
        /// <returns>Weather data for given coordinates</returns>
        Task<ForecastWeatherData> ForecastAsync(float latitude, float longitude);
        ...
        /// <param name="localization">Localization for weather descriptions</param>
        /// <returns>Weather data for given coordinates</returns>
        Task<ForecastWeatherData> ForecastAsync(float latitude, float longitude, Localization localization);
        ...
        /// </param>
        /// <returns>Weather data for given post code/zipcode</returns>
        Task<ForecastWeatherData> ForecastAsync(string code);
        ...
        /// <param name="localization">Localization for weather descriptions</param>
        /// <returns>Weather data for given post code/zipcode</returns>
        Task<ForecastWeatherData> ForecastAsync(string code, Localization localization);
    }
}
